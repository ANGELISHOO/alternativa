...
<head>
    ...
    <title>Ingreso nuevo funcionario</title>
...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="container">
        <h2 class="text">Ingresar Nuevo Funcionario</h2>
        <form action="insert_docente.php" method="POST">
            <input type="text" name="funcionario" placeholder="Nombres del Funcionario" required>
        ...
        <h2 class="text">Funcionarios Registrados</h2>
    ...
    $sql = "SELECT * FROM funcionario WHERE funcionario LIKE '%$searchTerm%' OR activo LIKE '%$searchTerm%'";
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div><a href='update_funcionario.php?id=".$row['id']."' class='bg-teal-500 p-1.5 rounded-[4px]'>Editar</a></div>";
            echo "<div><a href='delete_funcionario.php?id=".$row['id']."' class='bg-rose-500 p-1.5 rounded-[4px]'>Eliminar</a></div>";
            echo "</div>";
            echo "</td>";
            echo "</tr>";
        }
