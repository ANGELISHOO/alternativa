...
// Modificar la consulta SQL para unir con las tablas de referencia
$sql = "
    SELECT i.*, te.nombre_tipo_elemento AS tipo_elemento_desc
    FROM inventario i
    JOIN tipo_elemento te ON i.tipo_elemento = te.id
    WHERE i.ubicacion LIKE '%$searchTerm%' 
    OR te.nombre_tipo_elemento LIKE '%$searchTerm%' 
    OR i.fecha_de_ingreso LIKE '%$searchTerm%' 
    OR i.elementos LIKE '%$searchTerm%'
";
...
<head>
    ...
    <title>Ingreso nuevo docente</title>
    ...
    width: 100%; /* Reduce el ancho del formulario */
...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="container">
        <h2 class="text">Inventario Actual</h2>
        ...
        <table id="example" class="display nowrap">
            ...
            <?php
                ...
                if (!empty($searchTerm)) {
                    $sql .= " WHERE elementos LIKE '%" . mysqli_real_escape_string($con, $searchTerm) . "%'";
                }
