...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="container">
        <form method="GET">
        <center><h2 class="text">Requisiciones</h2></center>
    ...
    $sql = "SELECT * FROM requisicion WHERE num_requisicion LIKE '%$searchTerm%' OR docente LIKE '%$searchTerm%' OR fecha_solicitud LIKE '%$searchTerm%' OR fecha_de_entrega LIKE '%$searchTerm%' OR grupo_encargado LIKE '%$searchTerm%' OR funcionario LIKE '%$searchTerm%' OR evento LIKE '%$searchTerm%' OR anulada LIKE '%$searchTerm%'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<tr><td colspan='7'>No se encontro la requisicion</td></tr>";
    }
    ?>
</tbody>
            </table>
