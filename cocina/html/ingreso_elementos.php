...
<head>
    ...
    <title>Ingreso nuevo elemento</title>
...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="container">
        <h2 class="text">Ingresar Nuevo Elemento</h2>
        <form action="insert_ingreso_elemento.php" method="POST">            
            <!-- Campo de selección para "Elemento" -->
        ...
        <h2 class="text">Elementos Ingresados</h2>
        </form>
        ...
        <table id="dataTable">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM ingreso_elementos";
                if (!empty($searchTerm)) {
                    $sql .= " WHERE elemento LIKE '%" . mysqli_real_escape_string($con, $searchTerm) . "%'";
                }
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td class="grid-btns-crud">
                            <div><a href="update_ingreso_elementos.php?id=' . $row['id'] . '">Editar</a></div>
                            <div><a href="delete_ingreso_elementos.php?id=' . $row['id'] . '">Borrar</a></div>
                          </td>';
                    echo '</tr>';
                }
                ?>
