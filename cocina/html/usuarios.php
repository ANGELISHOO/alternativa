            ...
            <table class="border-2 border-neutral-400 dark:border-neutral-700 w-4/5">
                <thead>
                    <tr class="border-2 border-neutral-400 dark:border-neutral-700 text-xs text-center dark:bg-[#242528] bg-slate-400/70 font-bold h-8 dark:text-slate-200">
                        ...
                        <th class="border-2 border-neutral-400 dark:border-neutral-700 p-1.5">id_nivel</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                    $sql = "SELECT * FROM usuarios WHERE id_nivel = 1"; 
                    ...
                    ?>
                        <tr class="border border-neutral-400 text-xs text-center dark:bg-[#27282be8] bg-slate-300/75 dark:text-[#dfe4ebef]">
                            ...
                            <th class="border-2 border-neutral-400 dark:border-neutral-700 p-1.5"><?php echo $row['rol']   ?></th>
                            <th class="border-2 border-neutral-400 dark:border-neutral-700 p-1.5"><?php echo $row['id_nivel']   ?></th>
                        </tr>
                <?php } ?>
                </tbody>
            </table>
