...
<body class="main m-0 overflow-y-scroll py-2">
    <div class="container">
        ...
        <form action="edit_docente.php" method="POST"><h2>Actualizar</h2>
            ...
            <input type="text" name="nombre" placeholder="Nombre del docente" value="<?= $row['nombre'] ?>" class="h-11 rounded-xl border-none dark:text-[#E2E8F0] bg-slate-300/60 font-normal outline-none focus:bg-[#FFFFFF] focus:ring-2 focus:ring-Light-Blue dark:bg-[#27282be8] dark:placeholder:text-[#7a8190] dark:focus:bg-[#242528]">
            <input type="text" name="curso" placeholder="Curso" value="<?= $row['curso'] ?>" class="h-11 rounded-xl border-none dark:text-[#E2E8F0] bg-slate-300/60 font-normal outline-none focus:bg-[#FFFFFF] focus:ring-2 focus:ring-Light-Blue dark:bg-[#27282be8] dark:placeholder:text-[#7a8190] dark:focus:bg-[#242528]">
