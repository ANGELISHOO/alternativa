        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM inventario WHERE cantidad_inicial LIKE '%$searchTerm%' OR cantidad_final LIKE '%$searchTerm%' OR ubicacion LIKE '%$searchTerm%' OR tipo_elemento LIKE '%$searchTerm%' OR fecha_de_ingreso LIKE '%$searchTerm%' OR elementos LIKE '%$searchTerm%'";
