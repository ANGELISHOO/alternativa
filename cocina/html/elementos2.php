...
<input type="checkbox" id="nav-toggle">
    <div id="nav-bar">
        ...
        <div class="container">
        <h2 class="text">elementos registrados</h2>
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM elementos WHERE elementos LIKE '%$searchTerm%' OR tipo_elemento LIKE '%$searchTerm%' OR clase LIKE '%$searchTerm%' OR inventario LIKE '%$searchTerm%'";
